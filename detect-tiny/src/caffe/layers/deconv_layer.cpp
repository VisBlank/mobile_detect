...
void DeconvolutionLayer<Dtype>::compute_output_shape() {
  ...
  //printf("DeconvolutionLayer compute_output_shape start...\n");
  ...
  //printf("DeconvolutionLayer compute_output_shape end!!\n");
}
...
void DeconvolutionLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
  ...
  //printf("DeconvolutionLayer Forward_cpu start...\n");
  ...
  //printf("DeconvolutionLayer Forward_cpu end!!\n");
}
/*
template <typename Dtype>

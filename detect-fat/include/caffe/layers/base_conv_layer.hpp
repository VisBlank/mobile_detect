...
class BaseConvolutionLayer : public Layer<Dtype> {
 public:
  ...
  //explicit BaseConvolutionLayer(const shared_ptr<Layer<Dtype> >& param): Layer<Dtype>(param) {}
    ...
    {
        /*
        Layer<Dtype>* other = (Layer<Dtype>  *)conv;
        ...
        */
        //std::cout<<"copy BaseConvolutionLayer:"<<((Layer<Dtype>  *)conv)->blobs().size()<<std::endl;
        ...
        /*
        kernel_shape_.CopyFrom(conv->kernel_shape());
        stride_.CopyFrom(conv->stride());
        pad_.CopyFrom(conv->pad());
        dilation_.CopyFrom(conv->dilation());
        conv_input_shape_.CopyFrom(conv->conv_input_shape());
        std::copy(conv->col_buffer_shape().begin(), conv->col_buffer_shape().end(), std::back_inserter(col_buffer_shape_));
        std::copy(conv->output_shape().begin(), conv->output_shape().end(), std::back_inserter(output_shape_));
        col_buffer_.CopyFrom(conv->col_buffer());
        bias_multiplier_.CopyFrom(conv->bias_multiplier());
         */
    }

...
class SmoothL1LossParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.SmoothL1LossParameter) */ {
 public:
  ...
  static const SmoothL1LossParameter* internal_default_instance();
  ...
  void UnsafeMergeFrom(const SmoothL1LossParameter& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<SmoothL1LossParameter> SmoothL1LossParameter_default_instance_;
...
inline const SmoothL1LossParameter* SmoothL1LossParameter::internal_default_instance() {
  return &SmoothL1LossParameter_default_instance_.get();
}
// -------------------------------------------------------------------
